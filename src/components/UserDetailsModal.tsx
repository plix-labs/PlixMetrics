            ...
            >
                ...
                {user && (
                    <div className="flex flex-col h-full overflow-hidden">
                        ...
                        <div className="flex-1 overflow-y-auto custom-scrollbar bg-slate-900 relative -mt-12 rounded-t-3xl border-t border-slate-700/50">
                            <div className="p-8 pt-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
                                            ...
                                            {user.activity_heatmap.map((count, hour) => {
                                                ...
                                                return (
                                                    <div key={hour} className="flex-1 flex flex-col group relative h-full">
                                                        {/* Tooltip */}
                                                        <div className="mb-2 opacity-0 group-hover:opacity-100 transition-opacity absolute bottom-full left-1/2 -translate-x-1/2 bg-slate-800 text-xs px-2 py-1 rounded border border-slate-700 whitespace-nowrap z-10 pointer-events-none shadow-lg font-mono">
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-3">
                                            {user.last_watched.slice(0, 4).map((item, i) => (
                                                <div key={i} className="flex items-center gap-4 p-3 bg-slate-800/30 hover:bg-slate-800/60 rounded-xl transition-colors border border-transparent hover:border-slate-700/50 group">
